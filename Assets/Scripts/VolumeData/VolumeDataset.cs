...
namespace UnityVolumeRendering
{
    ...
    public class VolumeDataset : ScriptableObject
    {
        ...
        {
            int MAX_DIM = 256; // 2048; // 3D texture max size. See: https://docs.unity3d.com/Manual/class-Texture3D.html
        ...
        private Texture3D CreateTextureInternal()
        {
            ...
            // extract
            //AssetDatabase.CreateAsset(texture, "Assets/DICOMs/model_texture.asset");
