...
namespace UnityVolumeRendering
{
    public class VolumeObjectFactory
    {
        public static VolumeRenderedObject CreateObject(VolumeDataset dataset)
        {
            ...
            // extract
            //AssetDatabase.CreateAsset(noiseTexture, "Assets/DICOMs/model_noise.asset");
            //AssetDatabase.CreateAsset(tfTexture, "Assets/DICOMs/model_tf.mat");
            //AssetDatabase.CreateAsset(meshRenderer.sharedMaterial, "Assets/DICOMs/model_material.mat");
